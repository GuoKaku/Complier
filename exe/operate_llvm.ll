...
@"prior" = global [6 x [6 x i32]] zeroinitializer
@"value" = common global %"stack" zeroinitializer, align 4
@"op" = common global %"stack" zeroinitializer, align 4
define void @"init"(i32 %"note")
{
entry:
  %"note.1" = alloca i32
  store i32 %"note", i32* %"note.1"
  %".4" = load i32, i32* %"note.1"
  %".5" = icmp eq i32 %".4", 0
  %".6" = icmp ne i1 %".5", 0
...
define void @"push"(i32 %"note", i32 %"n")
{
entry:
  %"note.1" = alloca i32
  store i32 %"note", i32* %"note.1"
...
.10.endif.if:
  ...
  %".87" = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* @"prior", i32 0, i32 %".86"
...
.103.if:
  ...
  %".122" = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* @"prior", i32 0, i32 %".121"
